...
func webserver(port string) {
	...
	// pdf
	r.HandleFunc("/api/pdf-to-json", handlerAPIPdfToJson).Methods(http.MethodPost, http.MethodOptions)
	...
	r.HandleFunc("/api/rmitem", handleAPIRmItem).Methods("POST") // legacy
