...
func handleEditDepartment(w http.ResponseWriter, r *http.Request) {
	...
	q := r.URL.Query()
	id := q.Get("id")
	rcp.Department, err = getDepartmentV2(client, id)
	if err != nil {
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return
	}
...
func handleEditTeam(w http.ResponseWriter, r *http.Request) {
	...
	q := r.URL.Query()
	partID := q.Get("id")
	rcp.Team, err = getTeamV2(client, partID)
	if err != nil {
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return
	}
...
func handleEditRole(w http.ResponseWriter, r *http.Request) {
	...
	q := r.URL.Query()
	id := q.Get("id")
	rcp.Role, err = getRoleV2(client, id)
	if err != nil {
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return
	}
...
func handleEditPosition(w http.ResponseWriter, r *http.Request) {
	...
	q := r.URL.Query()
	id := q.Get("id")
	rcp.Position, err = getPositionV2(client, id)
	if err != nil {
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return
	}
...
func handleEditDivision(w http.ResponseWriter, r *http.Request) {
	...
	rcp.Division, err = getDivisionV2(client, id)
	if err != nil {
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return
	}
...
func handleEditDivisionSubmit(w http.ResponseWriter, r *http.Request) {
	...
	current, err := getDivisionV2(client, r.FormValue("ID"))
	if err != nil {
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return
	}
	...
	err = setDivisionV2(client, renewal)
	if err != nil {
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return
	}
...
func handleEditDepartmentSubmit(w http.ResponseWriter, r *http.Request) {
	...
	defer client.Disconnect(context.Background())
	current, err := getDepartmentV2(client, r.FormValue("ID"))
	if err != nil {
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return
	}
	...
	err = setDepartmentV2(client, renewal)
	if err != nil {
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return
	}
...
func handleEditTeamSubmit(w http.ResponseWriter, r *http.Request) {
	...
	defer client.Disconnect(context.Background())
	current, err := getTeamV2(client, r.FormValue("ID"))
	if err != nil {
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return
	}
...
func handleEditRoleSubmit(w http.ResponseWriter, r *http.Request) {
	...
	defer client.Disconnect(context.Background())
	current, err := getRoleV2(client, r.FormValue("ID"))
	if err != nil {
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return
	}
...
func handleEditPositionSubmit(w http.ResponseWriter, r *http.Request) {
	...
	defer client.Disconnect(context.Background())
	current, err := getPositionV2(client, r.FormValue("ID"))
	if err != nil {
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return
	}
	...
	err = setPositionV2(client, renewal)
	if err != nil {
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return
	}
